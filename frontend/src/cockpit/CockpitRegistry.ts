...
export const COCKPIT_WIDGET_REGISTRY: Record<string, CockpitWidgetManifest> = {
  'cockpit.market-regime': {
    ...
    defaultLayout: { x: 0, y: 0, w: 4, h: 8, minW: 3, minH: 3 },
    category: 'regime',
  },
  'cockpit.setup-monitor': {
    ...
    defaultLayout: { x: 4, y: 0, w: 8, h: 10, minW: 6, minH: 4 },
    category: 'setup',
  },
  'cockpit.cockpit-chart': {
    ...
    defaultLayout: { x: 4, y: 0, w: 5, h: 10, minW: 4, minH: 6 },
    category: 'chart',
  },
  'cockpit.decision-panel': {
    ...
    defaultLayout: { x: 9, y: 0, w: 3, h: 10, minW: 3, minH: 6 },
    category: 'decision',
  },
  'cockpit.position-list': {
    ...
    defaultLayout: { x: 0, y: 8, w: 6, h: 8, minW: 4, minH: 4 },
    category: 'position',
  },
  'cockpit.pending-orders': {
    ...
    defaultLayout: { x: 6, y: 8, w: 6, h: 8, minW: 4, minH: 4 },
    category: 'position',
  },
  'cockpit.action-list': {
    ...
    defaultLayout: { x: 0, y: 16, w: 12, h: 6, minW: 6, minH: 3 },
    category: 'action',
  },
  'cockpit.pool-builder': {
    ...
    defaultLayout: { x: 0, y: 22, w: 12, h: 10, minW: 6, minH: 4 },
    category: 'pool',
  },
  'cockpit.weekly-stage': {
    ...
    defaultLayout: { x: 0, y: 43, w: 6, h: 10, minW: 3, minH: 5 },
    category: 'chart',
  },
  'cockpit.repricing-trigger': {
    ...
    defaultLayout: { x: 6, y: 43, w: 6, h: 10, minW: 4, minH: 4 },
    category: 'repricing',
  },
}
